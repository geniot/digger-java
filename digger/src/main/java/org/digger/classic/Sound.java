...
class Sound {
    ...
    int musicp = 0, tuneno = 0, noteduration = 0, notevalue = 0, musicmaxvol = 0, musicattackrate = 0,
            musicsustainlevel = 0, musicdecayrate = 0, musicnotewidth = 0, musicreleaserate = 0, musicstage = 0,
            musicn = 0;
     ...
     * 0x7d64};
     *
     * int backgjingle[]={ // [291] 0xfdf,2,0x11d1,2,
     * 0xfdf,2,0x1530,2,0x1ab2,2,0x1530,2,0x1fbf,4, 0xfdf,2, 0x11d1,2,
     * 0xfdf,2,0x1530,2,0x1ab2,2,0x1530,2,0x1fbf,4, 0xfdf,2, 0xe24,2, 0xd59,2,
     * 0xe24,2, 0xd59,2, 0xfdf,2, 0xe24,2, 0xfdf,2, 0xe24,2,0x11d1,2,
     ...
     * 0xa98,4,0x7d64};
     *
     * int dirge[]={ 0x7d00, 2,0x11d1, 6,0x11d1, 4,0x11d1, 2,0x11d1, 6, 0xefb, 4,
     * 0xfdf, 2, 0xfdf, 4,0x11d1, 2,0x11d1, 4,0x12e0,
     * 2,0x11d1,12,0x7d00,16,0x7d00,16,
...
//	timer2(40);
    ...
    void soundlevdone() {
        ...
        // }
        /*
         * int timer=0; soundstop(); nljpointer=0; nljnoteduration=20;
         * soundlevdoneflag=soundpausedflag=true; while (soundlevdoneflag) { if
         * (timerclock==timer) continue; soundlevdoneupdate(); timer=timerclock; }
         */
    }
