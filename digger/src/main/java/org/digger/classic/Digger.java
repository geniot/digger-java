...
//                newSound.playExplode();
    ...
    public void init() {
        ...
        // Pc.displayUpdater = new MemoryDisplayUpdater(this, getGraphics(), rotated, Pc.pixels, Pc.width, Pc.height, 2);
        // Pc.displayUpdater.setPallete(0, Pc.pal[0][0], Pc.pal[0][1], Pc.pal[0][2]);
        // Pc.displayUpdater.setPallete(1, Pc.pal[1][0], Pc.pal[1][1], Pc.pal[1][2]);

        for (int i = 0; i < 2; i++) {
            Pc.source[i] = new MemoryImageSource(Pc.width, Pc.height,
                    new IndexColorModel(8, 4, Pc.pal[i][0], Pc.pal[i][1], Pc.pal[i][2]), Pc.pixels, 0, Pc.width);
...
//            newSound.fireEnd();
    ...
    public void update(Graphics g) {
        ...
        g2.clearRect(0, 0,
                Pc.currentImage.getWidth(null) * 2 + PADDING * 4,
                Pc.currentImage.getHeight(null) * +PADDING * 4);
        g2.scale(2.0, 2.0);
        g2.drawImage(Pc.currentImage, PADDING, PADDING, this);
    }
...
//                    newSound.fireStart();
            ...
            switch (firedir) {
                ...
                case 6:
                    firey += 7;
                    pix = (Pc.ggetpix(firex, firey) | Pc.ggetpix(firex, firey + 1) | Pc.ggetpix(firex, firey + 2)
                            | Pc.ggetpix(firex, firey + 3) | Pc.ggetpix(firex, firey + 4) | Pc.ggetpix(firex, firey + 5)
